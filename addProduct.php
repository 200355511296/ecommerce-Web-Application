                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-3 border-end border-light">
                                    <div class="row">
                                        <div class="col-12">
                                ...
                                <div class="col-12 col-lg-5 border-end border-light">
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-12">
                                            <div class="input-group mt-2 mb-2">
                                                <input type="text" class="form-control" placeholder="Add new Colour" id="add" />
                                                <button class="btn btn-outline-dark bi bi-plus-circle-fill" type="button"></button>
                                            </div>
                                        </div> -->
                        ...
                        <div class="col-12 justify-content-center">
                            ...
                            <div class="col-12 mt-3 ">
                                ...
                                <label for="imageuploader" class="col-4 offset-4 btnMain p-2 text-center fs-5" onclick="changeProductImage();">Upload Images</label>
                            </div>
                        ...
                        <div class="col-12 d-none " id="msgdiv">
                            ...
                            <div class="alert alert-danger border border-3 border-danger text-center" role="alert" id="msg">
                        ...
                        <div class=" row  ">
                            ...
                            <div class="col-4 col-lg-4 offset-lg-4 d-grid mt-3 mb-3 offset-3 ">
                                <button class="btnSub fw-bold text-dark fs-5" onclick="addProduct();">Save Product</button>
                            </div>

                            <div class=" col-2 col-lg-4 d-grid mt-3 mb-3 ">
                                <a href="myProducts.php"><button class="btn btn-secondary fw-bold">Back</button></a>
                            </div>
