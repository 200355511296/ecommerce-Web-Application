...
if(isset($_POST["e"])){
    ...
    if($admin_num > 0){
        ...
        $mail->SMTPSecure = 'ssl';
        $mail->Port = 465;
        $mail->setFrom('chathuriw222@gmail.com', 'Admin Verification');
        $mail->addReplyTo('chathuriw222@gmail.com', 'Admin Verification');
        $mail->addAddress($email);
        $mail->isHTML(true);
        $mail->Subject = 'Glee Admin Login Verification Code';
