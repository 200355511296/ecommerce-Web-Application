                        ...
                        <div class="list-unstyled list-list-unstyled list-inline">
                            ...
                            <div class="grid gap-5">
                                ...
                                <div class="p-2 list-inline-item text-center">
                                    ...
                                    <p class=" text-light d-none d-sm-block d-md-block">My Sellings</p>

                                </div>

                                <div class="p-2 list-inline-item text-center">
                                    <a href="myProducts.php" class="form-floating text-white ">
                                        <i class="bi bi-bag-plus-fill" style="font-size: 30px;"></i>
                                    </a>
                                    <p class=" text-light d-none d-sm-block d-md-block">My Products</p>
                                ...
                                <div class="p-2 list-inline-item text-center">
                                    <a href="userProfile.php" class="form-floating text-white ">
                                        <i class="bi bi-person-lines-fill" style="font-size: 30px;"></i>
                                    </a>
                                    <p class=" text-light d-none d-sm-block d-md-block">Contact Admin</p>
