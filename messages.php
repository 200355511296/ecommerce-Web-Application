                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                ...
                                                <div class="message_box mt-2" id="message_box">
                                                    ...
                                                    ?>
                                                            <div class="list-group rounded-0" onclick="viewMessage('<?php echo $sender; ?>');">
                                                                ...
                                                                <a href="#" class="list-group-item list-group-item-action text-dark rounded-0 bg-primary bg-opacity-10 mt-2">
                                            ...
                                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                ...
                                                <div class="message_box" id="message_box">
                                                    ...
                                                    for ($y = 0; $y < $msg_num2; $y++) {
                                                        ...
                                                        $user_rs3 = Database::search("SELECT * FROM `user` INNER JOIN `profile_img` ON 
                                                        user.email=profile_img.user_email WHERE `email`='" . $receiver . "'");

                                                        $user_rs4 = Database::search("SELECT * FROM `user` WHERE `email`='" . $receiver . "'");

                                                        $user_data4 = $user_rs4->fetch_assoc();
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="list-group rounded-0" onclick="viewMessage('<?php echo $receiver; ?>');">
                                                            <a href="#" class="list-group-item list-group-item-action text-black rounded-0 bg-secondary mb-2">
                                                                <div class="media">
                                                                    ...
                                                                    <div class="me-4">
                                                                        <div class="d-flex align-items-center justify-content-between mb-1 ">
                                                                            <h6 class="mb-0 fw-bold"> <?php echo $user_data4["fname"] . " " . $user_data4["lname"]; ?> </h6>
